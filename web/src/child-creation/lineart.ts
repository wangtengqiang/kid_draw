...
function deerLegs(): { id: number; pts: Ring }[] {
  return [
    { id: 14, pts: [[-0.4, 0.7], [-0.4, 0.02]] },
    { id: 15, pts: [[-0.28, 0.7], [-0.28, 0.02]] },
    { id: 12, pts: [[0.4, 0.7], [0.4, 0.02]] },
    { id: 13, pts: [[0.52, 0.7], [0.52, 0.02]] },
  ]
}
...
function catLegs(backShift = 0): { id: number; pts: Ring }[] {
  return [
    { id: 11, pts: [[-0.5 + backShift, 0.62], [-0.5 + backShift, 0.02]] },
    { id: 12, pts: [[-0.34 + backShift, 0.62], [-0.34 + backShift, 0.02]] },
    { id: 9, pts: [[0.48, 0.62], [0.48, 0.02]] },
    { id: 10, pts: [[0.62, 0.62], [0.62, 0.02]] },
  ]
}
...
function lionLegs(): { id: number; pts: Ring }[] {
  return [
    { id: 10, pts: [[-0.46, 0.62], [-0.46, 0.02]] },
    { id: 11, pts: [[-0.3, 0.62], [-0.3, 0.02]] },
    { id: 8, pts: [[0.42, 0.62], [0.42, 0.02]] },
    { id: 9, pts: [[0.56, 0.62], [0.56, 0.02]] },
  ]
}
