...
export class PreviewStage {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.camera.position.set(2.25, 1.62, 1.28)
    this.camera.lookAt(0.88, 1.02, 0)
    this.orbit = new OrbitZoom(canvas, this.camera, new THREE.Vector3(0.88, 1.02, 0), PREVIEW_ORBIT)
