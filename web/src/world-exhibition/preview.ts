...
export class PreviewStage {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.camera.position.set(3.15, 1.48, 0.42)
    this.camera.lookAt(0.15, 0.92, 0)
    this.orbit = new OrbitZoom(canvas, this.camera, new THREE.Vector3(0.15, 0.92, 0), PREVIEW_ORBIT)
