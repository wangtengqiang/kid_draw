...
export class PreviewStage {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.camera.position.set(-3.15, 1.55, 0.55)
    this.camera.lookAt(0.1, 0.95, 0)
    this.orbit = new OrbitZoom(canvas, this.camera, new THREE.Vector3(0.1, 0.95, 0), PREVIEW_ORBIT)
