/**
 * Layer 1 live forest: land lion/deer/tiger keep the approved cartoon cutouts.
 * `lion.glb` is an authored volume attempt (see process/effect stills) and is
 * not loaded over the forest — it was uglier than play-action-walk.png.
 * Marine still glTF.
 */
