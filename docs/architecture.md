...
| 目录 | 谁用 | 做什么 | 不做什么 |
| --- | --- | --- | --- |
| `child-creation/` | 小朋友 | 选小鹿 / 老虎 / 狮子 → **自由蜡笔**涂色（线稿只是样子）→ 导出贴图 → **送进世界** → 成功页 **去看大世界** | 不换主题、不拍照 |
| `paper-coloring/` | 老师下载；小朋友拍照 | 下载可打印官方线稿（四角对准标记）；选一只（只限这三只）→ 拍照或选图 → 透视对准模板 → 采样分区色 → **同一条 sendToWorld**；成功页也可进大世界 | 不用 AI 猜未知动物；孩子首页不是下载列表 |
