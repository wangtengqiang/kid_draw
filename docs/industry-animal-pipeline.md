...
Adopted: Quaternius Ultimate Animated Animals (CC0) Stag=deer, Wolf=tiger, Fox=lion — https://quaternius.com/packs/ultimateanimatedanimals.html
GLBs: https://media.githubusercontent.com/media/danwahl/animasim/main/assets/generated/glb/{stag,wolf,fox}.glb
Zsky Lion.glb was fetched (CC BY 4.0, https://opengameart.org/sites/default/files/animals_pack.zip) but the mane still reads as petal-spheres, so it is not the default.
